...
* `"AC-Environment-Id": "Customer organization ID"` – この値を [Commerce クラウドプロジェクト &#x200B;](https://experienceleague.adobe.com/ja/docs/commerce-on-cloud/user-guide/project/overview#project-overview) から取得します。
