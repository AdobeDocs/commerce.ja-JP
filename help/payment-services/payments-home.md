...
オンボーディングが完了するまで、**[!UICONTROL Home]**&#x200B;には&#x200B;**[!UICONTROL ACCS Onboarding Required]**&#x200B;が表示されます。 この通知は、[ サンドボックスサービスを設定](sandbox.md#enable-sandbox-testing) （テスト PayPal処理アカウントを使用）するか、別の環境で既にテストしている場合は[ ライブ決済を有効にする](production.md#enable-live-payments)にリンクしています。
