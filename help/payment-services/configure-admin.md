...
以前のリリースでは、web サイト レベルのPayPal アカウントマッピングでは、通常、[ サポート ](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide.html#Solution)またはAdobe担当者にお問い合わせください。 以下の前提条件を満たす場合は、**[!UICONTROL Connect different account]** アクションを使用します。
