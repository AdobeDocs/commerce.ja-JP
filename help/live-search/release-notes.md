...
![ バグ ](../assets/bug.svg) [!DNL Live Search] は、複数の [ 仮想） ](https://experienceleague.adobe.com/ja/docs/commerce-admin/inventory/sources/sources-manage) 在庫 [&#128279;](https://experienceleague.adobe.com/ja/docs/commerce-admin/inventory/stocks/stocks-manage) を持つ（単一ソース  （物理）在庫の場所をサポートしています。 複数のインベントリソースは現在サポートされていません。
