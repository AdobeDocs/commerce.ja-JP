...
ライブサーチの使用と設定に関する詳細なビデオについては、 [!DNL Live Search]&#x200B;[&#128279;](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/getting-started/capabilities/live-search-full-demonstration)の完全デモを参照してください。
