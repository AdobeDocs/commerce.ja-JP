...
次の製品属性には、[!DNL Live Search]によって使用され、デフォルトで有効になっている[&#x200B; ストアフロントプロパティ &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/product-attributes/product-attributes)があります。
