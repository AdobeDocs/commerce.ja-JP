...
ファセット処理は、属性値の複数の次元を検索条件として使用する高性能フィルタリングの方法です。 ファセット検索は類似していますが、標準の[階層化ナビゲーション ](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/catalog/navigation/navigation-layered)よりもかなり「スマート」です。 使用可能なフィルターのリストは、検索結果で返される商品の[ フィルター可能な属性](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/catalog/navigation/navigation-layered#filterable-attributes)によって決まります。
...
| 設定 | 説明 |
|--- |--- |
| [ カテゴリの表示設定](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/categories/create/categories-display-settings) | アンカー – `Yes` |
| [属性プロパティ ](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/product-attributes/create/attribute-product-create) | [ カタログ入力タイプ ](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/product-attributes/attributes-input-types) - `Yes/No`、`Dropdown`、`Multiple Select`、`Price`、`Visual swatch` （ウィジェットのみ）、`Text swatch` （ウィジェットのみ） |
