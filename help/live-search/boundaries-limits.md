...
- [がインストールされている場合、](https://experienceleague.adobe.com/ja/docs/commerce-admin/catalog/catalog/search/search)詳細検索[!DNL Live Search] モジュールは無効になり、ストアフロントフッターの詳細検索リンクは削除されます。
