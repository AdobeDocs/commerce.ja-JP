---
title: サービスガイド ホーム
description: Commerce SaaS サービスに関するAdobe Commerceの製品ドキュメントをご覧ください
...
Adobe Commerceサービスは、ストアフロントの拡張、統合の合理化、データ管理の最適化を実現する強力な機能を提供します。
...
- **ストアフロントサービス** – 商品の検索、レコメンデーション、支払いにAIを活用した機能
- **統合サービス** - Adobe Experience Platform、AEM Assets、その他のAdobe ソリューションへの接続
...
ストアフロントサービスとは、商品の発見を最適化し、顧客インタラクションをパーソナライズし、決済処理を合理化してエンゲージメントとコンバージョンを向上させる、AIを活用した機能のグループです。 ストアフロントサービスを利用すれば、ショッピング体験を向上させ、ビジネスの成長を促進することができます。
...
<tr style="border: 0;">
   ...
   <td valign="top">
      ...
      <p>
         <em>AIを活用したこの検索ツールを実装して、B2Cの買い物客によりスマートかつ迅速に、より適切な検索結果を提供します。</em>
      </p>
   </td>
   <td valign="top">
      <a href="../product-recommendations/overview.md">
      <img alt="サムズアップ" src="../assets/icons/ThumbUp.svg" width="40">
      </a>
      <div>
         <a href="../product-recommendations/overview.md">
   ...
   <td valign="top">
      ...
      <img alt="クレジットカード決済" src="../assets/icons/CreditCard.svg" width="40">
      </a>
      <div>
         <a href="../payment-services/guide-overview.md">
...
統合サービスとは、Adobe内の他の製品やサービスにCommerce インスタンスを接続する機能を指します。

<table style="table-layout:fixed">
<tr style="border: 0;">
   <td valign="top">
      <a href="../data-connection/overview.md">
      <img alt="データをプラットフォームに転送" src="../assets/icons/TransferToPlatform.svg" width="40">
      </a>
      <div>
         <a href="../data-connection/overview.md">
      ...
      <p>
         <em>Adobe CommerceとAdobe Experience Platform edgeの連携を活用して、Commerce データをAdobe AnalyticsやAdobe Targetなどの他のAdobe Experience Cloud製品に使用します。</em>
      </p>
   </td>
   <td valign="top">
      ...
      <img alt="LLMの最適化" src="../assets/icons/gauge4.svg" width="40">
      </a>
      <div>
          <a href="../llmo-integration/overview.md">
         <strong>[!DNL Adobe LLM Optimizer]統合</strong>
         </a>
      </div>
      <p>
         <em> カタログを[!DNL Adobe LLM Optimizer]に接続して、AI主導の回答で製品がどのように表示されるかを監視し、承認済みの製品名と説明の更新を商談から[!DNL Adobe Commerce]にデプロイします。</em>
      </p>
   </td>
   <td valign="top">
      <a href="../app-management/overview.md">
      <img alt="アプリ管理" src="../assets/icons/DataSetting.svg" width="40">
      </a>
      <div>
         <a href="../app-management/overview.md">
         <strong> アプリ管理</strong>
...
データツールは、Commerce インスタンスと接続されたサービス間の情報フローを管理および最適化するのに役立ちます。 これらのツールは、リソースを集約したプロセスをオフロードすることで、効率的なデータ同期を確保し、同期操作をモニターして、パフォーマンスを向上させます。
...
## Commerce Servicesが解決できる課題？

Adobe Commerceサービスは、ビジネスの拡大、顧客体験の向上、データにもとづく意思決定など、Commerceに関する一般的な課題の解決に役立ちます。
...
Adobe Commerceサービスは、統合基盤の上に構築されています。 複数のサービスを利用する場合、次のようなメリットがあります。

- **統合データパイプライン** – 製品、価格、在庫のデータがあらゆるサービスで自動的に同期されるため、重複したデータ入力やカスタム統合が不要になります。
- **リアルタイムのパーソナライゼーション** – 検索、閲覧、購入などの顧客行動により、ストアフロント全体でインテリジェントなレコメンデーションとランキングを実現します。
- **一貫性のあるストアフロントの統合** - Edge Delivery Services、PWA Studio、ヘッドレス実装を搭載したCommerce ストアフロントを使用している場合でも、同じドロップインとAPIがすべてのプラットフォームでシームレスに機能します。
- **マルチストアおよび多言語サポート** – すべてのサービスは、追加の設定なしで、ストアビュー、顧客セグメント、B2B カタログ設定を自動的に尊重します。
- **リッチな商品ビジュアル** - AEM Assetsと統合すると、最適化された商品画像が、検索結果、商品ページ、レコメンデーション全体で一貫して表示されます。
- **接続された顧客データ** - Data Connectionを使用して、Adobe Experience Platform、Real-Time CDP、Journey Optimizerとショッピング行動を共有し、クロスチャネルのパーソナライゼーションとキャンペーンの最適化を実現します。

例えば、買い物客がライブサーチで商品を検索し、商品レコメンデーションを閲覧した後に商品をカートに追加し、支払いサービスで購入を完了すると、これらのアクティビティはすべて統合されたデータパイプラインをシームレスに流れます。 この行動データにより、より優れた検索結果と、将来の買い物客により適切なレコメンデーションが提供されます。

>[!NOTE]
>
>サービス間で行動データ共有を有効にするには、イベントデータ収集を設定する必要があります。 設定手順については、[Commerce サービスの設定](saas.md#saas-configuration)を参照してください。

各サービスは個別に利用することができますが、それらを組み合わせることで、よりインテリジェントでパーソナライズされたショッピング体験を実現できます。
