...
<table style="table-layout:auto;">
  ...
  <tbody>
    ...
    <tr>
      <td><p>SaaS データ書き出し</a>の<a href="https://experienceleague.adobe.com/en/docs/commerce/saas-data-export/feed-lock-mechanism"> フィードロック機能を追加して、フィードのロックが同時同期の競合を防ぐ仕組みと、Commerce データ書き出しログ （<code>commerce-data-export.log</code>）に含まれる通常のスキップメッセージを解釈する方法を説明しました。</p>
</td>
      <td>
        新しいトピック
      </td>
