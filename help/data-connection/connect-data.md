...
1. 実装したサーバー間認証方法を **Adobe Developer認証タイプ** メニューから選択します。 Adobeでは、OAuth を使用することをお勧めします。 [学習を増やす](https://developer.adobe.com/commerce/webapi/rest/authentication/server-to-server/)。
