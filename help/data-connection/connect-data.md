...
>[!TIP]
>
>Experience Platformにプロファイルデータが表示されない場合は、[Commerce KnowledgeBase](https://experienceleague.adobe.com/ja/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/data-connection-customer-profiles-not-exported)でトラブルシューティングの候補を参照してください。
