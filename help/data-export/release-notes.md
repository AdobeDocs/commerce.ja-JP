...
![ 修正 ](../assets/fix.svg) PHP 8.5 で `di:compile` コマンドが失敗する問題を修正しました。コンパイル処理が正常に完了し、最新の PHP バージョンとの互換性が確保されました。<!--MDEE-1299-->
