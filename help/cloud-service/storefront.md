...
* [ ストアフロント B2B機能](https://experienceleague.adobe.com/developer/commerce/storefront/setup/configuration/storefront-compatibility/b2b/#major-features) – すべての[!DNL Adobe Commerce as a Cloud Service] インスタンスに対して自動的にインストールされるストアフロント互換性パッケージで利用可能なB2B機能について説明します。
