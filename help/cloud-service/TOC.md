...
- [Adobe Commerceas a Cloud Service](overview.md)
- [機能の比較](feature-comparison.md)
...
- [顧客としてログイン](login-as-customer.md)
- [ギフトカードアカウント API](gift-card-account-api.md)
- [メールトリガー](email-triggering.md)
- チュートリアル {#tutorials}
