...
The limit on the number of websites, stores, and store views was previously limited to 50. You can now submit a [support request](https://experienceleague.adobe.com/home?lang=ja&support-tab=home#support) to modify these limits, if necessary. <!-- ACCS-398 -->
