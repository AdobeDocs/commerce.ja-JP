...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="https://experienceleague.adobe.com/en/tools/commerce-storefront/merchants/get-started/">ストアフロントビルダー</a></td>
        </tr>
        <tr>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Adobe managed. お客様は、[!DNL App Builder]個のアプリに[!DNL OpenTelemetry]を、ストアフロントにRUM ダッシュボードを使用できます。 [!DNL New Relic] ライセンスは含まれていません。 お客様は、自分の[!DNL New Relic] アカウントにデータを送信するように[!DNL API Mesh]と[!DNL App Builder]を設定できます。</td>
        </tr>
        <tr>
            <td>CDN</td>
