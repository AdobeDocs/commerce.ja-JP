...
この図では、システム管理者とマーチャントが[!DNL Adobe Commerce as a Cloud Service] インスタンスにアクセスして管理する方法の概要を示します。 管理者ワークフローについて詳しくは、[Adobe Admin Console ガイド ](https://helpx.adobe.com/business/enterprise.html)を参照してください。
...
インスタンスを作成したので、[!DNL Edge Delivery Services]を利用して[ ストアフロントを設定](storefront.md)する準備が整いました。

## 関連資料

* [リリースノート](release-notes.md)
* [移行ガイド](migration/overview.md)
* [Commerce Storefrontのドキュメント](https://experienceleague.adobe.com/en/tools/commerce-storefront/)
