...
組織がプロビジョニングされたタイミングに基づいて、[!DNL Adobe Commerce Optimizer] に製品管理者ユーザーを追加する方法は 2 つあります。 アーリーアクセス組織では、製品管理者の役割を割り当てられた各ユーザーには、組織内のすべてのインスタンスを管理する権限があります。 2025 年 10 月 13 日（PT）以降にプロビジョニングされた一般提供（GA）組織では、特定のインスタンスの製品管理者としてユーザーを割り当てることができます。 製品管理者ユーザーがログインすると、管理権限を持っているインスタンスのみが表示されます。
...
>[!NOTE]
>
>製品管理者とシステム管理者のみが、ユーザーと開発者を [!DNL Adobe Commerce Optimizer] 製品に追加できます。
...
- [&#x200B; ユーザーグループ &#x200B;](https://helpx.adobe.com/jp/enterprise/using/user-groups.html){target="_blank"} を作成して、1 つの役割に複数のユーザーを追加します。 その後、適切な製品をユーザーグループに追加できます。
