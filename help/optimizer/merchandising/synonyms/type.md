...
以前と同様に条件を個別に検索する場合は、[&#x200B; サポートチケットを作成できます](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide)。 十分な需要がある場合、[!DNL Adobe Commerce Optimizer]は、今後のリリースでこの機能を製品に追加することを検討します。
