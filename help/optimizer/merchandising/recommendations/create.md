...
1. _[!DNL Adobe Commerce Optimizer]_サイドバーで、_ マーチャンダイジング _/**レコメンデーション**に移動して_ レコメンデーション _ワークスペースを表示します。
...
1. _[!DNL Adobe Commerce Optimizer]_サイドバーで、_ マーチャンダイジング _/**レコメンデーション**に移動します。
