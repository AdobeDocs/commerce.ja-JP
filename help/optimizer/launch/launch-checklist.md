...
▢適切な権限がDA コンテンツおよびEDS サイト用に設定されています。オーサリング ](https://www.aem.live/docs/authentication-setup-authoring)については、[DA.live権限](https://da.live/docs/administration/permissions)および[認証設定を参照してください。
