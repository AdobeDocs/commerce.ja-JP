...
統合を有効にするには、[&#x200B; とAEM Assetsの詳細を指定して &#x200B;](https://experienceleague.adobe.com/ja/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#submit-ticket) サポートチケットを作成 [!DNL Commerce Optimizer] します。 Adobe サポートは、統合を設定し、テナントをAssets Integration Service に登録します。
