...
カタログソースは、商品、属性、カテゴリーの信頼できる範囲を表します。 カタログソースは通常、言語、オーディエンス、原産地系の境界にマッピングし、検索、フィルター、ソートの動作を決定します。
...
* カタログソースは、Data Ingestion APIを使用して製品を取り込むことで作成します。 詳しくは、[開発者ドキュメント – データ収集](https://developer.adobe.com/commerce/services/optimizer/data-ingestion/)を参照してください。
