...
IMS 認証はデフォルトで有効になっています。 ユーザーを **Adobe Admin Console&rbrace; の** AEM Assets DM OpenAPI ユーザー – 配信 [&#x200B; 製品プロファイルに追加して &#x200B;](https://adminconsole.adobe.com/)AEM Assets配信レイヤーへのアクセスを許可します。
