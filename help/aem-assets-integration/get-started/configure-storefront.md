...
Edge Delivery Servicesを搭載したCommerce StorefrontでAEM Assetsを使用する方法について詳しくは、*Adobe Commerce Storefront* ドキュメントの[AEM Assets統合](https://experienceleague.adobe.com/developer/commerce/storefront/setup/configuration/aem-assets-configuration/?lang=ja) トピックで説明されているストアフロント設定を完了してください。
