...
Edge Delivery Servicesを搭載したCommerce StorefrontでAEM Assetsを使用する方法について詳しくは、*AEM Assets Storefront* ドキュメントの[Adobe Commerce統合](https://experienceleague.adobe.com/developer/commerce/storefront/setup/configuration/aem-assets-configuration/) トピックを参照してください。
...
* *AEM Assets Storefront* ドキュメントの[Adobe Commerce統合](https://experienceleague.adobe.com/developer/commerce/storefront/setup/configuration/aem-assets-configuration/){target=_blank} - ストアフロントの設定とイメージ処理の動作。
