...
[!DNL Commerce Optimizer] とAEM Assets統合をオンボードするには、[&#x200B; サポートチケットを作成 &#x200B;](https://experienceleague.adobe.com/ja/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#submit-ticket) する必要があります。
...
1. **認証設定**:IMS サービストークン認証は、安全な通信のために [!DNL Commerce Optimizer] とAssets Integration Service の間に設定されます。
