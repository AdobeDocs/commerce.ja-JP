...
Recommendations用に[SaaS データスペース &#x200B;](../landing/saas.md#saas-configuration)を設定すると、SaaS データスペースはカタログデータとストアフロント行動データを収集します。 [Adobe AI](https://business.adobe.com/jp/ai.html)は、そのデータを分析し、商品レコメンデーションを提供するために使用される商品の関連付けを計算します。
