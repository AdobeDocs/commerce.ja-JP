...
準備状況の割合が低い場合は、このレコメンデーションタイプのレコメンデーションに含める資格のある製品がカタログにたくさんないことを示します。 つまり、このレコメンデーションタイプをデプロイした場合でも、[ バックアップレコメンデーション ](events.md#backuprecs) が返される可能性が高くなります。
